...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    KC_LCTL, KC_LALT, KC_LGUI, KC_NO,  KC_SPFN1,         KC_BSFN2,                  KC_RGUI,  KC_FN1, KC_FN2,  KC_RCTL
  ),
  ...
  [_FN2] = LAYOUT(
    ...
    _______, _______, _______, KC_DEL,  KC_PGDN, KC_END,  _______,          _______, _______, KC_LBRC, KC_RBRC, _______,
